...
<html lang="fr">
    ...
    <div class="container-fluid py-5 my-5 position-relative" id="bg_croisiere">
        
        <div class="container">
            
            
            <div class="row">
                <h1 class="col text-center">MODELE</h1>
            </div>
            
            <!-- <div class="row pt-3">
                <div class="col"></div>
                <h2 class="col-4 text-center info_planet">DIRECTION SATURNE</h2>
                <div class="col"></div>
            </div> -->
